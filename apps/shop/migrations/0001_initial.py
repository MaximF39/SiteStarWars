...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='BaseItems',
            fields=[
                ('class_number', models.IntegerField(primary_key=True, serialize=False, verbose_name='Номер класса')),
        ...
        migrations.CreateModel(
            name='Ships',
            fields=[
                ('type', models.CharField(auto_created='ship', default='ship', max_length=20)),
                ('class_number', models.IntegerField(primary_key=True, serialize=False, verbose_name='Номер класса')),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('name', models.CharField(max_length=100, verbose_name='Название')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(auto_created='ammo', default='ammo', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('baseitems_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='shop.baseitems')),
                ('type', models.CharField(auto_created='device', default='device', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('baseitems_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='shop.baseitems')),
                ('type', models.CharField(auto_created='engine', default='engine', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('baseitems_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='shop.baseitems')),
                ('type', models.CharField(auto_created='resource', default='resource', max_length=20)),
                ('effects', django.contrib.postgres.fields.ArrayField(base_field=django.contrib.postgres.fields.ArrayField(base_field=models.IntegerField(), size=None), null=True, size=None)),
            ],
            options={
                'verbose_name': 'Ресурс',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('baseitems_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='shop.baseitems')),
                ('type', models.CharField(auto_created='weapon', default='weapon', max_length=20)),
                ...
                ('restrictions', models.JSONField(null=True)),
                ('ammo_class', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='shop.ammo')),
            ],
            options={
                'verbose_name': 'Оружие',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('baseitems_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='shop.baseitems')),
                ('type', models.CharField(auto_created='droid', default='droid', max_length=20)),
                ('energy_cost', models.IntegerField()),
                ('armor', models.IntegerField()),
                ('droid_type', models.IntegerField()),
                ('max_health', models.IntegerField()),
                ('restrictions', models.JSONField(null=True)),
                ('weapon_class', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='shop.weapons')),
            ],
            options={
                'verbose_name': 'Дройд',
